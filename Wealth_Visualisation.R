...
Brazil_Wealth_Top1_Graph <- Brazil_NetPersonalWealth_Top1Percent %>%
  ...
  labs(title = "Trend of Net Personal Wealth Top 1% Share in Brazil",
       x = "Year",
       y = "% of Total Wealth") +
  theme_minimal()
...
Spain_Wealth_Top1_Graph <- Spain_NetPersonalWealth_Top1Percent %>%
  ...
  geom_point(shape = 15, size = 2) +
  scale_y_continuous(limits = c(0.15, 0.3))+
  labs(title = "Trend of Net Personal Wealth Top 1% Share in Spain",
       x = "Year",
       y = "% of Total Wealth") +
  theme_minimal()
...
Spain_Wealth_Top10_Graph <- Spain_NetPersonalWealth_Top10Percent %>%
  ...
  labs(title = "Trend of Net Personal Wealth Top 10% Share in Spain",
       x = "Year",
       y = "% of Total Wealth") +
  theme_minimal()
...
BrazilandSpain_Wealth_Top1_Graph <- ggplot() +
  ...
  scale_y_continuous(limits = c(0.15, 0.3))+
  labs(title = "Net Personal Wealth Top 1% Share: Brazil vs Spain",
