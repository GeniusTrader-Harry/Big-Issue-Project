...
BrazilandLatinAmerica_Income_Top1_Graph <- ggplot() +
  ...
  labs(title = "Pre-Tax Income Top 1% Share: Brazil vs Latin America",
       x = "Year", y = "% of Total Income", color = "Region") +
  theme_minimal()
...
BrazilandLatinAmerica_Income_Top10_Graph <- ggplot() +
  ...
  labs(title = "Pre-Tax Income Top 10% Share: Brazil vs Latin America",
       x = "Year", y = "% of Total Income", color = "Region") +
  theme_minimal()
...
BrazilandLatinAmerica_Wealth_Top1_Graph <- ggplot() +
  ...
  labs(title = "Net Personal Wealth Top 1% Share: Brazil vs Latin America",
       x = "Year", y = "% of Total Wealth", color = "Region") +
  theme_minimal()
...
BrazilandLatinAmerica_Wealth_Top10_Graph <- ggplot() +
  ...
  labs(title = "Net Personal Wealth Top 10% Share: Brazil vs Latin America",
       x = "Year", y = "% of Total Wealth", color = "Region") +
  theme_minimal()
...
SpainandEurope_Income_Top1_Graph <- ggplot() +
  ...
  labs(title = "Pre-Tax Income Top 1% Share: Spain vs Europe",
       x = "Year", y = "% of Total Income", color = "Region") +
  theme_minimal()
...
SpainandEurope_Income_Top10_Graph <- ggplot() +
  ...
  labs(title = "Pre-Tax Income Top 10% Share: Spain vs Europe",
       x = "Year", y = "% of Total Income", color = "Region") +
  theme_minimal()
...
SpainandEurope_Wealth_Top1_Graph <- ggplot() +
  ...
  scale_y_continuous(limits = c(0.15, 0.3)) +
  labs(title = "Net Personal Wealth Top 1% Share: Spain vs Europe",
       x = "Year", y = "% of Total Wealth", color = "Region") +
  theme_minimal()
...
SpainandEurope_Wealth_Top10_Graph <- ggplot() +
  ...
  labs(title = "Net Personal Wealth Top 10% Share: Spain vs Europe",
       x = "Year", y = "% of Total Wealth", color = "Region") +
  theme_minimal()
